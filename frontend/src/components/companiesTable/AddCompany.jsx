...
import { addCompanyTableData, addCompanyTableDataReset } from '../../context/actions/companyActions/addCompany';
...
const AddCompany = (props) => {
    ...
    const { companyAddedData, companyAddDataLoading, companyAddedDataIsError, companyAddedDataError, companyAddedDataIsSuccess } = companyTableState;
    ...
    const submitCompanyData = (e) => {
        e.preventDefault();
        addCompanyTableData(inputdata)(companyTableDispatch)
    }
    ...
    useEffect(() => {
        ...
        if (companyAddedDataIsSuccess) {
            ...
            addCompanyTableDataReset()(companyTableDispatch)
            sessionStorage.setItem("companiesPage", 1)
            setCurrentPage(1)
            getCompanyTable({ search: "", gender: "all", status: "all", sort: "new", page: 1 })(companyTableDispatch)
