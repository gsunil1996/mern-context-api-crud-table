...
import { editEmployee, editEmployeeReset } from '../../context/actions/employeeActions/editEmployee';
import { getEmployeeProfileReset } from '../../context/actions/employeeActions/getEmployeeProfile';
...
const EditEmployee = (props) => {
    ...
    const { employeeEditedData, employeeEditDataLoading, employeeEditDataIsError, employeeEditDataError, employeeEditDataIsSuccess } = employeeTableState
    ...
    const { employeeProfileData, employeeProfileIsLoading, employeeProfileIsError, employeeProfileError, employeeProfileIsSuccess } = employeeTableState;
    ...
    const submitEmployeeData = (e) => {
        ...
        editEmployee(payload)(employeeTableDispatch)
    }
    ...
    useEffect(() => {
        ...
        if (employeeEditDataIsSuccess) {
            ...
            editEmployeeReset()(employeeTableDispatch)
            getEmployeeProfileReset()(employeeTableDispatch)
            getEmployeeTable({ search: "", gender: "all", status: "all", sort: "new", page: currentPage })(employeeTableDispatch)
